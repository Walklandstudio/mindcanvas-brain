...
import { getActiveOrg } from "@/app/_lib/portal";
      ...
      <div className="bg-white/5 border-b border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-2 text-sm flex items-center justify-between">
          ...
          <div className="flex gap-3">
            {/* handy switch link; add others as needed */}
            <Link className="underline hover:opacity-80" href="/portal/use?slug=competency-coach&next=/portal/home">
              Use competency-coach
            </Link>
          </div>
        </div>
      </div>
