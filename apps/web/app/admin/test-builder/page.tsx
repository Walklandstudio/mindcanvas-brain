...
/** The 15 base questions (same shape we used in templates) */
...
export default function LegacyTestBuilderPage() {
  // local editable copy (so Rephrase writes update what you see)
  ...
  function createTest(mode: 'free' | 'full') {
    // same alert UX as before (placeholder link for demo)
