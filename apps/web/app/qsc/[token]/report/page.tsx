...
export default function QscEntrepreneurStrategicReportPage({
  ...
  const renderShell = (content: React.ReactNode) => (
    <div className="min-h-screen relative text-slate-50">
      <BackgroundGrid />
      {/* dark overlay to keep things moody */}
      <div className="fixed inset-0 -z-[5] bg-slate-950/90" />
  ...
  return renderShell(
    <>
      ...
      <section className="rounded-3xl border border-slate-700 bg-slate-900/80 p-6 md:p-8 space-y-4 shadow-xl shadow-black/40">
        <p className="text-xs font-semibold tracking-[0.25em] uppercase text-sky-300">
          Quantum profile
        </p>
      ...
      <section className="rounded-3xl border border-slate-700 bg-slate-900/80 p-6 md:p-8 space-y-4 shadow-lg shadow-black/30">
      ...
      {/* ONE-PAGE SUMMARY */}
      <section className="rounded-3xl border border-amber-500/40 bg-amber-950/40 p-6 md:p-8 space-y-4 shadow-lg shadow-black/40">
        ...
        <div className="grid gap-6 md:grid-cols-3 pt-4">
          <div className="rounded-2xl bg-slate-950/70 border border-amber-500/40 p-4 text-sm space-y-2">
          ...
          <div className="rounded-2xl bg-slate-950/70 border border-amber-500/40 p-4 text-sm space-y-2">
            ...
            <h4 className="mt-2 font-semibold text-amber-50">Risks</h4>
            <p className="text-amber-100">
      ...
      <section className="rounded-3xl bg-slate-900/80 shadow-lg shadow-black/40 border border-slate-700 p-6 md:p-8 space-y-4">
        <p className="text-xs font-semibold tracking-[0.25em] uppercase text-sky-300">
          Buyer Persona Matrix
        </p>
        <h2 className="text-xl font-semibold text-slate-50">
      ...
      <section className="rounded-3xl bg-slate-900/80 shadow-lg shadow-black/40 border border-slate-700 p-6 md:p-8 space-y-4">
        ...
        <div className="mt-4 rounded-2xl border border-dashed border-slate-700 bg-slate-950/80 p-4 text-sm">
